...
public class RGBProgram extends ShaderProgram {
    ...
    public RGBProgram(Context context, int width, int height) {
        ...
        mUniformSTextureLocation = GLES20.glGetUniformLocation(program, "s_texture");
        mUniformMatrixLocation = GLES20.glGetUniformLocation(program, "u_Matrix");
    ...
    public void setUniforms(byte[] data, float scaleX, float scaleY, int rotateDegrees) {
        ...
        Matrix.scaleM(mMatrix, 0, scaleX, scaleY, 1);
        Matrix.rotateM(mMatrix, 0, rotateDegrees, 0.0f, 0.0f, 1.0f);
        GLES20.glUniformMatrix4fv(mUniformMatrixLocation, 1, false, mMatrix, 0);
    }
