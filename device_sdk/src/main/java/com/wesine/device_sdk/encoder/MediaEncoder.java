...
//	            if (DEBUG) Log.v(TAG, "encode:queueInputBuffer");
                if (length <= 0) {
                    // send EOS
                    mIsEOS = true;
                    Logger.d("send BUFFER_FLAG_END_OF_STREAM");
...
//        	throw new NullPointerException("muxer is unexpectedly null");
        ...
        while (mIsCapturing) {
            ...
            if (encoderStatus == MediaCodec.INFO_TRY_AGAIN_LATER) {
                ...
                // unexpected status
                Logger.d("drain:unexpected result from encoder#dequeueOutputBuffer: d%", encoderStatus);
            } else {
                ...
                if ((mBufferInfo.flags & MediaCodec.BUFFER_FLAG_CODEC_CONFIG) != 0) {
                    ...
                    Logger.d("drain:BUFFER_FLAG_CODEC_CONFIG");
                    mBufferInfo.size = 0;
                }
